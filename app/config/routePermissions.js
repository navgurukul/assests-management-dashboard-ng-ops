...
const STUDENT_EMPLOYEE_ONLY = ['STUDENT', 'EMPLOYEE', 'MANAGER'];
const EMPLOYEE_ONLY = ['EMPLOYEE', 'MANAGER'];
const ALL_AUTHENTICATED = ['ADMIN', 'IT_LEAD', 'IT_COORDINATOR', 'OPERATION', 'RESIDENTIAL_TEAM', 'EMPLOYEE', 'STUDENT', 'MANAGER'];
/**
