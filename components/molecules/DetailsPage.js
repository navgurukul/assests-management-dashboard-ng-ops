...
export default function DetailsPage({
  ...
  return (
    <div className="h-full flex flex-col bg-[var(--background)] p-3 sm:p-5 overflow-y-auto lg:overflow-y-hidden">
      {/* Header */}
      ...
      {/* 30-70% Split Layout */}
      <div className="flex flex-col lg:flex-row gap-5 flex-1 lg:min-h-0">
        {/* Left Column - 30% */}
