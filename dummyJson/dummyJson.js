...
export const userListData = [
  {
    ...
    assetType: 'Laptop',
    assetBrand: 'Dell',
    assetModel: 'Inspiron 15',
    assetCondition: 'Working',
    assetCampus: 'Bangalore',
    assetSerialNumber: 'DL-SN-88421',
  ...
  },
  {
    id: 2,
    name: 'Priya Verma',
    email: 'priya.verma@navgurukul.org',
    role: 'Student',
    campus: 'Pune',
    assetTag: 'NG-LT-042',
    assetType: 'Laptop',
    assetBrand: 'HP',
    assetModel: 'ProBook 450',
    assetCondition: 'Working',
    assetCampus: 'Pune',
    assetSerialNumber: 'HP-SN-30211',
    allocationDate: '05/03/2025',
    returnDate: '—',
    allocationStatus: 'Active',
    allocationReason: 'Joiner',
  },
  {
    id: 3,
    name: 'Rahul Nair',
    email: 'rahul.nair@navgurukul.org',
    role: 'Mentor',
    campus: 'Dharamshala',
    assetTag: 'NG-LT-017',
    assetType: 'Laptop',
    assetBrand: 'Lenovo',
    assetModel: 'ThinkPad E14',
    assetCondition: 'Working',
    assetCampus: 'Dharamshala',
    assetSerialNumber: 'LN-SN-55293',
    allocationDate: '20/06/2024',
    returnDate: '—',
    allocationStatus: 'Active',
    allocationReason: 'Joiner',
  },
  {
    id: 4,
    name: 'Sneha Kulkarni',
    email: 'sneha.kulkarni@navgurukul.org',
    role: 'Student',
    campus: 'Sarjapur',
    assetTag: 'NG-LT-059',
    assetType: 'Laptop',
    ...
    assetCampus: 'Sarjapur',
    assetSerialNumber: 'AC-SN-10456',
    allocationDate: '10/09/2024',
    returnDate: '15/01/2025',
    allocationStatus: 'Returned',
    allocationReason: 'Replacement',
  },
  {
    id: 5,
    name: 'Karan Mehta',
    email: 'karan.mehta@navgurukul.org',
    role: 'Staff',
    campus: 'Bangalore',
    assetTag: 'NG-LT-003',
    assetType: 'Laptop',
    assetBrand: 'Dell',
    assetModel: 'Latitude 5420',
    assetCondition: 'Working',
    assetCampus: 'Bangalore',
    assetSerialNumber: 'DL-SN-76512',
    allocationDate: '01/04/2024',
    returnDate: '—',
    allocationStatus: 'Active',
    allocationReason: 'Joiner',
  },
  {
    id: 6,
    name: 'Divya Reddy',
    email: 'divya.reddy@navgurukul.org',
    role: 'Student',
    campus: 'Pune',
    ...
    allocationDate: 'N/A',
    returnDate: '—',
    allocationStatus: 'No Allocation',
    allocationReason: 'N/A',
  },
  {
    id: 7,
    name: 'Amit Joshi',
    email: 'amit.joshi@navgurukul.org',
    role: 'Student',
    campus: 'Dharamshala',
    assetTag: 'NG-LT-088',
    assetType: 'Laptop',
    assetBrand: 'HP',
    assetModel: 'Pavilion 14',
    assetCondition: 'Faulty',
    assetCampus: 'Dharamshala',
    assetSerialNumber: 'HP-SN-99012',
    allocationDate: '22/07/2024',
    returnDate: '10/12/2024',
    allocationStatus: 'Returned',
    allocationReason: 'Repair',
  },
  {
    id: 8,
    name: 'Neha Singh',
    email: 'neha.singh@navgurukul.org',
    role: 'Admin',
    campus: 'Bangalore',
    assetTag: 'NG-LT-007',
    assetType: 'Laptop',
    assetBrand: 'Apple',
    assetModel: 'MacBook Air M1',
    assetCondition: 'New',
    assetCampus: 'Bangalore',
    assetSerialNumber: 'AP-SN-20034',
    allocationDate: '15/02/2025',
    returnDate: '—',
    allocationStatus: 'Active',
    allocationReason: 'Joiner',
  },
  {
    id: 9,
    name: 'Vijay Patil',
    email: 'vijay.patil@navgurukul.org',
    role: 'Student',
    campus: 'Sarjapur',
    assetTag: 'NG-LT-031',
    assetType: 'Laptop',
    assetBrand: 'Lenovo',
    assetModel: 'IdeaPad 3',
    assetCondition: 'Working',
    assetCampus: 'Pune',
    assetSerialNumber: 'LN-SN-44871',
    allocationDate: '03/10/2024',
    returnDate: '—',
    allocationStatus: 'Active',
    allocationReason: 'Loaner',
  },
  {
    id: 10,
    name: 'Meera Iyer',
    email: 'meera.iyer@navgurukul.org',
    role: 'Mentor',
    campus: 'Bangalore',
    assetTag: 'Not Assigned',
    assetType: 'N/A',
  ...
  },
  {
    id: 11,
    name: 'Ravi Kumar',
    email: 'ravi.kumar@navgurukul.org',
    role: 'Student',
    campus: 'Dharamshala',
    assetTag: 'NG-LT-065',
    assetType: 'Laptop',
    assetBrand: 'Dell',
    assetModel: 'Vostro 3400',
    assetCondition: 'Working',
    assetCampus: 'Dharamshala',
    assetSerialNumber: 'DL-SN-33217',
    allocationDate: '18/11/2024',
    returnDate: '—',
    allocationStatus: 'Active',
    allocationReason: 'Joiner',
  },
  {
    id: 12,
    name: 'Anjali Das',
    email: 'anjali.das@navgurukul.org',
    role: 'Student',
    campus: 'Pune',
    assetTag: 'NG-LT-074',
    assetType: 'Laptop',
    assetBrand: 'HP',
    assetModel: 'EliteBook 840',
    assetCondition: 'Damaged',
    assetCampus: 'Pune',
    assetSerialNumber: 'HP-SN-61123',
    allocationDate: '07/05/2024',
...
// Detailed Consignment List Data (for API-compatible format)
export const consignmentsListData = [
  // Draft status - testing create consignment flow
  {
    id: 101,
    consignmentCode: 'CON-TEST-020926-101',
    code: 'CON-TEST-020926-101',
    status: 'draft',
    allocationCode: 'ALLOC-2026-050',
    trackingId: '-',
    courierService: null,
    courierServiceName: '-',
    courierServiceId: '',
    source: 'Sarjapura Campus',
    destination: 'Pune Campus',
    shippedAt: null,
    ...
    assetCount: 2,
    assets: [
      { id: 201, assetTag: 'NG-SARJ-L-0401' },
      { id: 202, assetTag: 'NG-SARJ-L-0402' }
    ],
    allocation: {
      id: 50,
      allocationCode: 'ALLOC-2026-050',
  ...
  // Dispatched status - testing ready to dispatch flow
  {
    id: 102,
    consignmentCode: 'CON-TEST-020926-102',
    code: 'CON-TEST-020926-102',
    status: 'dispatched',
    allocationCode: 'ALLOC-2026-051',
    trackingId: '-',
    courierService: { id: 'dtdc', name: 'DTDC' },
    courierServiceName: 'DTDC',
    courierServiceId: 'dtdc',
    source: 'Himachal Campus',
    destination: 'Dantewada Campus',
    shippedAt: null,
    estimatedDeliveryDate: null,
    deliveredAt: null,
    trackingLink: '',
    assetCount: 3,
    assets: [
      { id: 203, assetTag: 'NG-HIMA-L-0201' },
      { id: 204, assetTag: 'NG-HIMA-L-0202' },
      { id: 205, assetTag: 'NG-HIMA-L-0203' }
    ],
    allocation: {
      id: 51,
      allocationCode: 'ALLOC-2026-051',
  ...
  },
  {
    ...
    courierServiceName: 'DTDC',
    courierServiceId: 'dtdc',
    trackingLink: 'https://www.dtdc.in/tracking/mobile/search.asp?invoiceno=DTDC987654321',
    source: 'Sarjapura Campus',
    destination: 'TechCare Repairs',
    shippedAt: '2026-02-01T10:30:00Z',
    estimatedDeliveryDate: '2026-02-05T18:00:00Z',
    deliveredAt: null,
    assetCount: 3,
    assets: [
      { id: 1, assetTag: 'NG-SARJ-L-0315' },
      { id: 2, assetTag: 'NG-SARJ-L-0316' },
      { id: 3, assetTag: 'NG-SARJ-L-0317' }
    ],
    allocation: {
      id: 45,
      allocationCode: 'ALLOC-2026-045',
  ...
  {
    id: 2,
    consignmentCode: 'CON-PUNE-020126-002',
    code: 'CON-PUNE-020126-002',
    status: 'delivered',
    allocationCode: 'ALLOC-2026-042',
    trackingId: 'BLUE123456789',
    courierService: { id: 2, name: 'Bluedart' },
    courierServiceName: 'Bluedart',
    courierServiceId: 'bluedart',
    trackingLink: 'https://www.bluedart.com/onlinetracking.asp?ShipmentNumber=BLUE123456789',
    source: 'Pune Campus',
    destination: 'Himachal Campus',
    shippedAt: '2026-01-28T14:00:00Z',
    estimatedDeliveryDate: '2026-02-01T18:00:00Z',
    deliveredAt: '2026-02-01T16:45:00Z',
    assetCount: 5,
    assets: [
      { id: 4, assetTag: 'NG-PUNE-L-0210' },
      { id: 5, assetTag: 'NG-PUNE-L-0211' },
      { id: 6, assetTag: 'NG-PUNE-L-0212' },
      { id: 7, assetTag: 'NG-PUNE-L-0213' },
      { id: 8, assetTag: 'NG-PUNE-L-0214' }
    ],
    allocation: {
      id: 42,
      allocationCode: 'ALLOC-2026-042',
  ...
  },
  {
    ...
    courierServiceName: 'Delhivery',
    courierServiceId: 'delhivery',
    trackingLink: 'https://track.delhivery.com/track/package/DELV456789012',
    source: 'Himachal Campus',
    destination: 'FixIT Repairs',
    shippedAt: '2026-01-30T08:15:00Z',
    estimatedDeliveryDate: '2026-02-04T17:00:00Z',
    deliveredAt: null,
    assetCount: 2,
    assets: [
      { id: 9, assetTag: 'NG-HIMA-L-0144' },
      { id: 10, assetTag: 'NG-HIMA-L-0145' }
    ],
    allocation: {
      id: 38,
      allocationCode: 'ALLOC-2026-038',
  ...
  {
    id: 4,
    consignmentCode: 'CON-DANT-012926-004',
    code: 'CON-DANT-012926-004',
    status: 'delivered',
    allocationCode: 'ALLOC-2026-035',
    trackingId: 'DTDC789012345',
    courierService: { id: 1, name: 'DTDC' },
    courierServiceName: 'DTDC',
    courierServiceId: 'dtdc',
    trackingLink: 'https://www.dtdc.in/tracking/mobile/search.asp?invoiceno=DTDC789012345',
    source: 'Dantewada Campus',
    destination: 'Pune Campus',
    shippedAt: '2026-01-27T11:00:00Z',
    estimatedDeliveryDate: '2026-01-30T18:00:00Z',
    deliveredAt: '2026-01-30T15:30:00Z',
    assetCount: 4,
    assets: [
      { id: 11, assetTag: 'NG-DANT-L-0029' },
      { id: 12, assetTag: 'NG-DANT-L-0030' },
      { id: 13, assetTag: 'NG-DANT-L-0031' },
      { id: 14, assetTag: 'NG-DANT-L-0032' }
    ],
    allocation: {
      id: 35,
      allocationCode: 'ALLOC-2026-035',
  ...
  },
  {
    ...
    courierServiceId: 'bluedart',
    trackingLink: '',
    source: 'Jabalpur Campus',
    destination: 'ServiceMax Repairs',
    shippedAt: null,
    estimatedDeliveryDate: '2026-02-06T18:00:00Z',
    deliveredAt: null,
    assetCount: 1,
    assets: [
      { id: 15, assetTag: 'NG-JABA-L-0045' }
    ],
    allocation: {
      id: 33,
      allocationCode: 'ALLOC-2026-033',
  ...
  },
  {
    ...
    courierService: { id: 3, name: 'Delhivery' },
    courierServiceName: 'Delhivery',
    source: 'Udaipur Campus',
    destination: 'Raipur Campus',
    shippedAt: '2026-01-24T13:30:00Z',
    estimatedDeliveryDate: '2026-01-28T18:00:00Z',
    deliveredAt: '2026-01-28T14:20:00Z',
    assetCount: 6,
    assets: [
      { id: 16, assetTag: 'NG-UDAI-L-0112' },
      { id: 17, assetTag: 'NG-UDAI-L-0113' },
      { id: 18, assetTag: 'NG-UDAI-L-0114' },
      { id: 19, assetTag: 'NG-UDAI-L-0115' },
      { id: 20, assetTag: 'NG-UDAI-L-0116' },
      { id: 21, assetTag: 'NG-UDAI-L-0117' }
    ],
    allocation: {
      id: 30,
      allocationCode: 'ALLOC-2026-030',
  ...
  },
  {
    ...
    courierService: { id: 1, name: 'DTDC' },
    courierServiceName: 'DTDC',
    source: 'Raipur Campus',
    destination: 'TechCare Repairs',
    shippedAt: '2026-01-25T15:00:00Z',
    estimatedDeliveryDate: '2026-02-03T18:00:00Z',
    deliveredAt: null,
    assetCount: 2,
    assets: [
      { id: 22, assetTag: 'NG-RAIP-L-0087' },
      { id: 23, assetTag: 'NG-RAIP-L-0088' }
    ],
    allocation: {
      id: 28,
      allocationCode: 'ALLOC-2026-028',
  ...
  },
  {
    ...
    courierService: { id: 2, name: 'Bluedart' },
    courierServiceName: 'Bluedart',
    source: 'Amaravati Campus',
    destination: 'Dharamshala Campus',
    shippedAt: '2026-01-22T10:00:00Z',
    estimatedDeliveryDate: '2026-01-26T18:00:00Z',
    deliveredAt: '2026-01-26T13:15:00Z',
    assetCount: 3,
    assets: [
      { id: 24, assetTag: 'NG-AMAR-L-0298' },
      { id: 25, assetTag: 'NG-AMAR-L-0299' },
      { id: 26, assetTag: 'NG-AMAR-L-0300' }
    ],
    allocation: {
      id: 25,
      allocationCode: 'ALLOC-2026-025',
  ...
  },
  {
    ...
    courierService: { id: 1, name: 'DTDC' },
    courierServiceName: 'DTDC',
    source: 'Kishangarh Campus',
    destination: 'Sarjapura Campus',
    shippedAt: '2026-01-20T12:00:00Z',
    estimatedDeliveryDate: '2026-01-24T18:00:00Z',
    deliveredAt: '2026-01-24T17:30:00Z',
    assetCount: 7,
    assets: [
      { id: 28, assetTag: 'NG-KISH-L-0050' },
      { id: 29, assetTag: 'NG-KISH-L-0051' },
      { id: 30, assetTag: 'NG-KISH-L-0052' },
      { id: 31, assetTag: 'NG-KISH-L-0053' },
      { id: 32, assetTag: 'NG-KISH-L-0054' },
      { id: 33, assetTag: 'NG-KISH-L-0055' },
      { id: 34, assetTag: 'NG-KISH-L-0056' }
    ],
    allocation: {
      id: 20,
      allocationCode: 'ALLOC-2026-020',
