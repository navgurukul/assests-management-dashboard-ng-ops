...
export default function TicketsTable({ filters = {}, onFilterChange, showCards, onToggleCards, summaryCardsComponent }) {
  ...
  const filterStatusOptions = [
    ...
    { value: 'CONSIGNMENT_CREATED', label: 'Consignment Created' },
    { value: 'CONSIGNMENT_DISPATCHED', label: 'Consignment Dispatched' },
    { value: 'CONSIGNMENT_DELIVERED', label: 'Consignment Delivered' },
    ...
    <TableWrapper
      ...
      searchComponent={
        <SearchInput
          ...
          placeholder="Search by ticket tag, description, or resolution notes..."
        />
      }
      // Filter component
      filterComponent={
