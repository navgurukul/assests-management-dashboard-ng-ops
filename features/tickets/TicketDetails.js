  ...
  const rightSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Address', value: ticket.address || '—', className: 'text-gray-900 line-clamp-2 break-all', title: ticket.address || undefined },
        ...
        { label: 'Description', value: ticket.description || '—', className: 'text-gray-900 line-clamp-2 break-all', title: ticket.description || undefined },
